...
function mindGame(positiveNumber) {
    if (typeof (positiveNumber) !== 'number' || positiveNumber < 0) {
        return 'please enter just any positive integer number.';
    }
    else {
...
function evenOdd(userStr) {
    if (typeof (userStr) !== 'string') {
        return 'please provide a string as an input parameter.';
    }
    else {
...
function gemsToDiamond(first, second, third) {
    if (typeof (first) !== 'number' || typeof (second) !== 'number' || typeof (second) !== 'number') {
